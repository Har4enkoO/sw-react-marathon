    ...
    nextPage = async () => {
      ...
      await this.setState(()=>{
        ...
        if(matches[0] === '2' || matches[0] === '3' || matches[0] === '17'){
          return {imageUrl: 'https://starwars-visualguide.com/assets/img/placeholder.jpg'}
        }
        return {imageUrl: `https://starwars-visualguide.com/assets/img/starships/${matches[0]}.jpg`}
     });
    }
        ...
        if (error) {
            ...
            return ( 
              <div className='jumbotron rounded'>
                ...
                <img
                  src={imageUrl}
                  alt={currentItem.name} className = 'starship-img'
                />
                <div>
